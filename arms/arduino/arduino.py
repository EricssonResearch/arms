...
class Arduino():
    ...
    def __init__(self):
        ...
        '''
        self.adjustment_pulses = 50 #number of pulses to send when adjusting
        self.upper_bound = 1.15 #adjusts the acceptable upper bound relative error 
        self.upper_bias = 15 #Bias limit on 
        self.lower_bound = 0.95 #adjust the acceptable lower bound
        self.lower_bias = 15 #Bias limit 
    ...
    def close_gripper(self,pulses,pressure):
        ...
        if(self.adjust_counter >= self.max_recursion):
            ...
            if self.pressure_received >= pressure:
                return True
            else:
                return False
